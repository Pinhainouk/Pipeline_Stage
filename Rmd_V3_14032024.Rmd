...
```{r, include=FALSE}
nombre_variants = data_frame(vcf_all %>% group_by (vcf_all$vcf) %>% count(vcf_all$type))
...
```{r, include=FALSE}
cat_vcf_all_nombre = cat_vcf_all %>% group_by (cat_vcf_all$categorie) %>% count(cat_vcf_all$type)
...
```{r, include=FALSE}
cat_vcf_all_genes = cat_vcf_all %>% group_by (cat_vcf_all$categorie) %>% count(cat_vcf_all$gene)
