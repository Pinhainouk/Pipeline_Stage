...
```{r}
plot9 = ggplot(bd_all, aes(x = nombre_reads, y = gene)) + geom_boxplot(aes(fill=bam)) + theme_classic() + 
  theme_classic() +
  labs(x = "Profondeur par position (bin 10)", y = "gene", title = "Boxplots de la profondeur par gène dans les bam (intervalle 10nt)") + 
  theme(plot.title = element_text(hjust = 0.5, size=14, face="bold"), plot.subtitle = element_text(hjust = 0.5)) + 
  labs(fill = "Noms des gènes") +
...
plot10 = ggplot(bd_all, aes(x = nombre_reads, y = bam)) + geom_boxplot(aes(fill=gene)) + theme_classic() + 
  theme_classic() +
  labs(x = "Nombre de reads dans les bam", y = "bam", title = "Boxplots de la profondeur dans les bam (intervalle 10 nt)") + 
  theme(plot.title = element_text(hjust = 0.5, size=14, face="bold"), plot.subtitle = element_text(hjust = 0.5)) + 
  labs(fill = "Noms des gènes") +
...
plot19 = UpSetR::upset(fromList(variants_list), order.by = "freq", text.scale = 2, point.size = 5, sets.bar.color = "#999999", main.bar.color = "#fc8d62")
plot19
```
...
plot21 = ggplot(nombre_annot, aes(fill=vcf, y=annot, x=n)) +
  geom_bar(position = position_fill(reverse=FALSE), stat="identity") +
  scale_fill_manual(values = c("#de2d26", "#2c7fb8", "#2ca25f", "#E69F00")) +
  labs(fill = "Nom des VCF", x = "Nombre de variants", y = "Annotation") + 
  theme(plot.title = element_text(hjust = 0.5, size=14, face="bold"), panel.grid = element_blank()) + 
  labs(title = "Annotation des variants par VCF") 
ggplotly(plot21)
```
...
```{r}
plot22 = ggplot(nombre_annot, aes(fill=gene, y=annot, x=n)) +
  geom_bar(position = position_fill(reverse=FALSE), stat="identity") +
  scale_fill_manual(values = c("#fdc086", "#91bfdb", "#b2df8a")) +
  labs(fill = "Nom des gènes", x = "Nombre de variants", y = "Annotation") + 
  theme(plot.title = element_text(hjust = 0.5, size=14, face="bold"), panel.grid = element_blank()) + 
  labs(title = "Annotation des variants par gène") 
ggplotly(plot22)
```
