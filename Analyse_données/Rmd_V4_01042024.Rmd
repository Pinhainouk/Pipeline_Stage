...
# Lolliplot - représentation des variants sur les gènes
...
plot19 = ggplot(nombre_annot, aes(fill=vcf, y=annot, x=n)) +
  geom_bar(position = position_fill(reverse=FALSE), stat="identity") +
...
```{r}
plot19 = ggplot(nombre_annot, aes(fill=gene, y=annot, x=n)) +
  geom_bar(position = position_fill(reverse=FALSE), stat="identity") +
  scale_fill_manual(values = c("#fdc086", "#91bfdb", "#b2df8a")) +
